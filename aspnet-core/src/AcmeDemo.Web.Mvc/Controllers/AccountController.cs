...
using AcmeDemo.Sessions;
using AcmeDemo.Web.Models.Account;
using AcmeDemo.Web.Views.Shared.Components.TenantChange;

namespace AcmeDemo.Web.Controllers
{
    public class AccountController : AcmeDemoControllerBase
    {
