...
{
    public abstract class AcmeDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AcmeDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AcmeDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AcmeDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AcmeDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AcmeDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AcmeDemoDbContext, Task<T>> func)
        {
            T result;
